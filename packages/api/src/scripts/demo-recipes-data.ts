/**
 * Shared recipe fixture data used by seed-demo-data.ts and seed-e2e-accounts.ts.
 */
...
export const RECIPES = [
  {
    ...
    steps: [
      ...
      { text: 'Freír en aceite caliente 3-4 minutos por lado hasta dorar.', durationSeconds: 480 },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        text: 'Hornear a 200°C por 20 minutos hasta dorar.',
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'Cubrir con el caldo y cocinar 35-40 minutos a fuego medio.', durationSeconds: 2400 },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        text: 'Hornear a 180°C por 35-40 minutos hasta dorar.',
  ...
  },
  {
    ...
    steps: [
      { text: 'Remojar el maíz y los porotos la noche anterior.', durationSeconds: 28800 },
      { text: 'Hervir maíz y porotos por 1 hora.', durationSeconds: 3600 },
      { text: 'En otra olla, dorar las carnes y el mondongo cortado.' },
      { text: 'Unir todo en la olla grande con el zapallo y las papas.' },
      { text: 'Cocinar a fuego lento 90 minutos hasta espesar.', durationSeconds: 5400 },
  ...
  },
  {
    ...
    steps: [
      { text: 'Tostar el pan en cubos con aceite y ajo hasta dorar.', durationSeconds: 300 },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'Refrigerar la masa 30 minutos.', durationSeconds: 1800 },
      { text: 'Estirar a 5mm, cortar círculos de 5cm.' },
      {
        text: 'Hornear 10-12 minutos a 170°C. No deben dorarse.',
        durationSeconds: 720,
        ovenTempC: 170,
      },
